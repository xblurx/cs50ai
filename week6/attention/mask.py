...
from transformers import AutoTokenizer, BatchEncoding, TFBertForMaskedLM
...
def get_mask_token_index(mask_token_id: int, inputs: BatchEncoding) -> int | None:
    ...
    found = np.where(ids == mask_token_id)[1]
...
def get_color_for_attention_score(attention_score: tf.Tensor):
    """
